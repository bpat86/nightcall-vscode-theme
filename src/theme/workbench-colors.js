...
function createWorkbenchColors(color) {
  return {
    ...
    "input.foreground": color.fg.emphasis,
    "input.placeholderForeground": color.fg.muted,
    "badge.foreground": color.fg.muted,
    "badge.background": color.canvas.inset,
    "progressBar.background": color.accent.fg,
    "extensionButton.prominentBackground": color.control.primary.bg,
    "extensionButton.prominentForeground": color.control.primary.fg,
    "extensionButton.prominentHoverBackground": color.control.primary.hoverBg,
    "extensionButton.background": color.control.secondary.bg,
    "extensionButton.foreground": color.control.secondary.fg,
    "extensionButton.hoverBackground": color.control.secondary.hoverBg,
    ...
    "extensionBadge.remoteForeground": color.fg.onEmphasis,
    "extensionIcon.starForeground": color.attention.fg,
    "extensionIcon.verifiedForeground": color.info.fg,
    "extensionIcon.preReleaseForeground": color.accent.secondary,
    "extensionIcon.sponsorForeground": color.accent.fg,
    "extensionIcon.privateForeground": color.fg.muted,
    "mcpIcon.starForeground": color.attention.fg,
    ...
    "modernActivityBarItem.activeBackground": alpha(color.accent.fg, 20),
    "modernActivityBarItem.hoverBackground": alpha(color.accent.fg, 15),
    "modernActivityBarItem.activeForeground": color.fg.onEmphasis,
    "modernActivityBarItem.hoverForeground": color.fg.onEmphasis,
    ...
    "activityBarBadge.foreground": color.accent.fg,
    ...
    "list.hoverForeground": color.fg.emphasis,
    "list.inactiveSelectionForeground": color.fg.emphasis,
    ...
    "list.focusForeground": color.fg.emphasis,
    ...
    "menu.foreground": color.fg.emphasis,
    ...
    "menubar.selectionForeground": color.fg.emphasis,
    ...
    "tab.unfocusedActiveForeground": color.fg.emphasis,
    ...
    "editorHoverWidget.foreground": color.fg.emphasis,
    ...
    "editorSuggestWidget.foreground": color.fg.emphasis,
    ...
    "editorWidget.foreground": color.fg.emphasis,
    ...
    "peekViewTitleLabel.foreground": color.fg.emphasis,
    ...
    "agentSessionReadIndicator.foreground": color.accent.fg,
    "agentSessionSelectedBadge.border": color.accent.fg,
    "agentSessionSelectedUnfocusedBadge.border": alpha(color.accent.fg, 50),
    "agentStatusIndicator.background": color.accent.fg,
