...
function createWorkbenchColors(color) {
  return {
    ...
    "activityBarBottom.foreground": color.fg.subtle,
    "activityBarBottom.inactiveForeground": color.fg.subtle,
    "activityBarBottom.background": color.canvas.inset,
    "activityBarBottom.activeBorder": color.accent.fg,
    "activityBarBottom.activeFocusBorder": color.accent.fg,
    "activityBarBottom.border": color.border.muted,
